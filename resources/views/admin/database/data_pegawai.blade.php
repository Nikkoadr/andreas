...
<section class="content">
    ...
    <div class="row">
        ...
        <div class="card">
            ...
            <!-- /.card-header -->
            <div class="card-body">
            <table id="table_data_pegawai" class="table table-bordered table-striped">
                <thead>
...
<script>
$(function () {
$("#table_data_pegawai").DataTable({
    "responsive": true, 
    "lengthChange": true, 
    "autoWidth": true,
    "buttons": ["copy", "csv", "excel", "pdf", "print", "colvis"]
}).buttons().container().appendTo('#table_data_pegawai_wrapper .col-md-6:eq(0)');
});
</script>
<script>
